...
add_action('wp_ajax_smart_donations_never_show_again','smart_donations_never_show_again');
add_action('wp_ajax_smart_donations_remind_me_later','smart_donations_remind_me_later');
...
function smart_donations_never_show_again(){
    update_option('smart_donations_review','-1');
}

function smart_donations_remind_me_later(){
    update_option('smart_donations_review',time());
}
